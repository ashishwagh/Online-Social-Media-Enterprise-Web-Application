...
public class FollowUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
		     follow = MySQLDataStoreUtilities.getPeopleToFollow(username);
		}
		catch(Exception e)
		{
		...
		for(Map.Entry<String, Users> entry : hm.entrySet())
		{
			...
			pw.print("<li><form method='post' action='SaveFollowUser'>" +
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='username' value='"+entry.getKey()+"'>"+
				    "<input type='submit' value='Write Testimonial' class='lbutton'></form></li>");
			pw.print("<li><form method='post' action='ViewReview'>"+"<input type='hidden' name='username' value='"+entry.getKey()+"'>"+
